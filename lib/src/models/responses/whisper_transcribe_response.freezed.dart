...
@JsonKey(name: '@type') String get type; String get text;@JsonKey(name: 'segments') List<WhisperTranscribeSegment>? get segments;// The compute backend this transcription actually resolved to (e.g.
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WhisperTranscribeResponse&&(identical(other.type, type) || other.type == type)&&(identical(other.text, text) || other.text == text)&&const DeepCollectionEquality().equals(other.segments, segments)&&(identical(other.backend, backend) || other.backend == backend));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,type,text,const DeepCollectionEquality().hash(segments),backend);

@override
String toString() {
  return 'WhisperTranscribeResponse(type: $type, text: $text, segments: $segments, backend: $backend)';
}
...
@useResult
$Res call({
@JsonKey(name: '@type') String type, String text,@JsonKey(name: 'segments') List<WhisperTranscribeSegment>? segments, String? backend
});
...
/// Create a copy of WhisperTranscribeResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? type = null,Object? text = null,Object? segments = freezed,Object? backend = freezed,}) {
...
as List<WhisperTranscribeSegment>?,backend: freezed == backend ? _self.backend : backend // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: '@type')  String type,  String text, @JsonKey(name: 'segments')  List<WhisperTranscribeSegment>? segments,  String? backend)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WhisperTranscribeResponse() when $default != null:
return $default(_that.type,_that.text,_that.segments,_that.backend);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: '@type')  String type,  String text, @JsonKey(name: 'segments')  List<WhisperTranscribeSegment>? segments,  String? backend)  $default,) {final _that = this;
switch (_that) {
case _WhisperTranscribeResponse():
return $default(_that.type,_that.text,_that.segments,_that.backend);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: '@type')  String type,  String text, @JsonKey(name: 'segments')  List<WhisperTranscribeSegment>? segments,  String? backend)?  $default,) {final _that = this;
switch (_that) {
case _WhisperTranscribeResponse() when $default != null:
return $default(_that.type,_that.text,_that.segments,_that.backend);case _:
  return null;
...
class _WhisperTranscribeResponse extends WhisperTranscribeResponse {
  const _WhisperTranscribeResponse({@JsonKey(name: '@type') required this.type, required this.text, @JsonKey(name: 'segments') required final  List<WhisperTranscribeSegment>? segments, this.backend}): _segments = segments,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WhisperTranscribeResponse&&(identical(other.type, type) || other.type == type)&&(identical(other.text, text) || other.text == text)&&const DeepCollectionEquality().equals(other._segments, _segments)&&(identical(other.backend, backend) || other.backend == backend));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,type,text,const DeepCollectionEquality().hash(_segments),backend);
...
/// Create a copy of WhisperTranscribeResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? type = null,Object? text = null,Object? segments = freezed,Object? backend = freezed,}) {
